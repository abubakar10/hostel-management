  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-2">Repairs</h1>
          <p className="text-gray-600 dark:text-gray-400">Track broken things in rooms until they are fixed</p>
        </div>
        <button
          onClick={() => {
            resetForm()
